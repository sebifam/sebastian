...
public class PersoanaController {
  ...
  public ResponseEntity adauga(@PathVariable("id") int id,
                               @PathVariable("name") String nume) {


        Persoana p4 = new Persoana(id,nume);
        this.persoane.add(p4);
   


        return new ResponseEntity<List<Persoana>>(persoane, new HttpHeaders(), HttpStatus.OK);
      }
